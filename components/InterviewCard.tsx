...
const Interview = ({interviewId,userId,role,type,createdAt,techstack}:InterviewCardProps) => {
  const normalizedType = /mix/gi.test(type)?"Mixed":type
  const feedback = null as Feedback | null // not same as sir said
    ...
    <div className="card-border w-[360px] max-sm:w-full min-h-96">
      <div className="card-interview">
        <div>
          ...
          <Image src={getRandomInterviewCover()} alt="cover-image" width={90} height={90} className="rounded-full object-fit size-[50px]"/>
